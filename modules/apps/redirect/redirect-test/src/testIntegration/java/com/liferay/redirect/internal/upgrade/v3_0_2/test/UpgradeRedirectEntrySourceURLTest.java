...
public class UpgradeRedirectEntrySourceURLTest {
	...
	public void testUpgradeWithMultipleGroup() throws Exception {
		long uppercaseRedirectId1 = _counterLocalService.increment();
		long uppercaseRedirectId2 = _counterLocalService.increment();
		long uppercaseRedirectId3 = _counterLocalService.increment();
		long uppercaseRedirectId4 = _counterLocalService.increment();
		long uppercaseRedirectId5 = _counterLocalService.increment();
		long uppercaseRedirectId6 = _counterLocalService.increment();

		addRedirectEntry(
			uppercaseRedirectId1, _group1.getGroupId(), _group1.getCompanyId(),
			"desination1", "Page1");
		addRedirectEntry(
			uppercaseRedirectId2, _group1.getGroupId(), _group1.getCompanyId(),
			"desination2", "Page2");
		addRedirectEntry(
			uppercaseRedirectId3, _group1.getGroupId(), _group1.getCompanyId(),
			"desination3", "Page3");

		addRedirectEntry(
			uppercaseRedirectId4, _group2.getGroupId(), _group2.getCompanyId(),
			"desination1", "Page1");
		addRedirectEntry(
			uppercaseRedirectId5, _group2.getGroupId(), _group2.getCompanyId(),
			"desination2", "Page2");
		addRedirectEntry(
			uppercaseRedirectId6, _group2.getGroupId(), _group2.getCompanyId(),
			"desination3", "Page3");
	...
	public void testUpgradeWithSourceURLCollision() throws Exception {
		if (_db.getDBType() == DBType.MYSQL) {
			...
			addRedirectEntry(
				uppercaseRedirectId1, _group1.getGroupId(),
				_group1.getCompanyId(), "desination1", "testpage");
			addRedirectEntry(
				uppercaseRedirectId2, _group1.getGroupId(),
				_group1.getCompanyId(), "desination2", "TestPage");
	...
	protected void setUpUpgradeSourceURL() {
